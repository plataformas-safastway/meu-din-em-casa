  ...
  public: {
    Tables: {
      ...
      ai_conversations: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_conversations_family_id_fkey"
            columns: ["family_id"]
            isOneToOne: false
            referencedRelation: "families"
            referencedColumns: ["id"]
      ...
      ai_error_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_error_events_family_id_fkey"
            columns: ["family_id"]
            isOneToOne: false
            referencedRelation: "families"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_ai_dashboard_metrics: { Args: { days_back?: number }; Returns: Json }
